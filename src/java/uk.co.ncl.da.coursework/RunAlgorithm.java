...
/**
* @description: run echo algorithm
* @author JayXu
...
public class RunAlgorithm {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Please input your filename（1～4）!");
        String s = sc.nextLine();
        if (!s.equals("1")&&!s.equals("2")&&!s.equals("3")&&!s.equals("4")){
            throw new IllegalArgumentException("Please input the correct filename from 1 to 4!");
        }
        ...
        //assembleNodeList & initiateMatrix
        ...
        System.out.println("Execution costs "+interval + " milliseconds！");
